...
def test_video(video = './video_test.mp4'):
    ...
    dorflex_cascade = cv.CascadeClassifier('dorflex-cascade.xml')
    fabercastel_cascade = cv.CascadeClassifier('fabercastel-cascade.xml')
    guaravito_cascade = cv.CascadeClassifier('guaravito-cascade.xml')
    fanta_cascade = cv.CascadeClassifier('fanta-cascade.xml')
    #brahma_cascade = cv.CascadeClassifier('brahma/data/cascade.xml')
    bioleve_cascade = cv.CascadeClassifier('bioleve-cascade.xml')
    ck_cascade = cv.CascadeClassifier('CK-cascade.xml')
    polenguinho_cascade = cv.CascadeClassifier('polenguinho-cascade.xml')
    italac_cascade = cv.CascadeClassifier('italac-cascade.xml')
